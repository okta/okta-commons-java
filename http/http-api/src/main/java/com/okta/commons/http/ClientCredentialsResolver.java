...
public interface ClientCredentialsResolver {
    ...
    ClientCredentialsResolver DISABLED = new DisabledClientCredentialsResolver();
    ...
    class DisabledClientCredentialsResolver implements ClientCredentialsResolver {
        ...
        private DisabledClientCredentialsResolver() {}
        ...
        private class DisabledClientCredentials implements ClientCredentials {
            @Override
